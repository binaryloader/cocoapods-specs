Pod::Spec.new do |s|
  ...
  s.version = '1.0.2'
  s.license = { :type => 'MIT' }
  s.homepage = 'https://github.com/binaryloader/iOS-Binaryloader-Extensions'
  ...
  s.source = { :git => 'https://github.com/binaryloader/iOS-Binaryloader-Extensions.git', :tag => s.version }
