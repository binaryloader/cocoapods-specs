Pod::Spec.new do |s|
  ...
  s.version = '1.0.4'
  s.license = { :type => 'MIT' }
  s.homepage = 'https://github.com/binaryloader/iOS-Binaryloader-DIContainer'
  ...
  s.source = { :git => 'https://github.com/binaryloader/iOS-Binaryloader-DIContainer.git', :tag => s.version }
