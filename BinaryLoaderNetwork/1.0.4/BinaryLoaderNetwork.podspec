Pod::Spec.new do |s|
  ...
  s.version = '1.0.4'
  s.license = { :type => 'MIT' }
  s.homepage = 'https://github.com/binaryloader/iOS-BinaryLoader-Network'
  ...
  s.source = { :git => 'https://github.com/binaryloader/iOS-BinaryLoader-Network.git', :tag => s.version }
